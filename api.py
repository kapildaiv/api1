...
def configure_ngrok():
    ngrok_token = "2pXEAEp0jQ9OjBHJeMy2C0fZdOs_4KGqJumNixthJvDNvUE"
    try:
...
def update_soul_txt(public_url):
    ...
    print(f"New ngrok link saved in api1.txt")
...
def update_vps_soul_txt(public_url):
    ...
    try:
        ...
        sftp.close()
        ssh.close()
        print("Updated api1.txt on VPS successfully.")
    except Exception as e:
        print(f"Failed to update api1.txt on VPS: {str(e)}")
